...
from initializer import GameInitializer  # ← statt initialCountries
...
class Game:
    ...
    def _assign_territories(self) -> None:
        assignments      = GameInitializer.distribute_countries(self.num_players)  # ← statt initialCountries
        ...
        if subphase == "intro":
            ...
            if self.combat_result_continue_rect and self.combat_result_continue_rect.collidepoint(pos):
                if self.combat_last_conquered or not self.combat_last_can_continue:
                    ...
                    self.pending_dice_count = min(Combat.MAX_ATTACKER_DICE, self.active_combat.attacking_territory.troops - 1)
                    self.attack_subphase    = "combat_roll"
    ...
    def _draw_hud(self) -> None:
        ...
        if phase == "placement":
            ...
            self.screen.blit(troop_num,   (panel_x + panel_w - troop_num.get_width() - 15,
            ...
            if subphase == "select_attacker":
                self.screen.blit(
                    self.font_small.render("Phase: Angriff – Angreifer wählen", True, (200, 200, 200)),
                    (panel_x + 18, panel_y + 38)
                )
                btn_w, btn_h = 320, 34
                btn_x = panel_x + 18
                ...
                pygame.draw.rect(self.screen, (80, 100, 80) if hover else (55, 75, 55),
                                 self.attack_end_phase_rect, border_radius=6)
                end_txt = self.font_small.render("Zug beenden (Angriff überspringen)", True, (200, 230, 200))
                ...
                self.screen.blit(
                    self.font_small.render("Phase: Angriff – Ziel wählen", True, (200, 200, 200)),
                    (panel_x + 18, panel_y + 38)
                )
    ...
    def _draw_turn_overlay(self) -> None:
        ...
        self.screen.blit(
            ...
            (card_x + card_w // 2 - self.font_small.size("DU BIST DRAN")[0] // 2, card_y + 25)
        )
        ...
        reinf_surf = self.font.render(f"Truppen zu setzen: {player.reinforcements}", True, (255, 230, 80))
        self.screen.blit(reinf_surf, (card_x + card_w // 2 - reinf_surf.get_width() // 2, card_y + 140))
    ...
    def _draw_attack_intro_overlay(self) -> None:
        ...
        self._blit_centered(self.font_small.render("ANGRIFFSPHASE", True, (180, 100, 100)), card_y + 25)
        self._blit_centered(self.font_large.render(player.name, True, player.color), card_y + 58)
        pygame.draw.line(self.screen, (80, 40, 40), (card_x + 30, card_y + 120), (card_x + 530, card_y + 120), 1)
        self._blit_centered(self.font.render("Waehle ein Territorium, das angreift", True, (230, 220, 220)), card_y + 138)
        self._blit_centered(self.font_small.render("(mind. 2 Truppen erforderlich)", True, (150, 130, 130)), card_y + 175)

        self.attack_intro_continue_rect = self._draw_button("Los geht's!", card_x, card_y + 242, 560, (170, 35, 35), (220, 70, 70))
    ...
    def _draw_attack_select_defender_overlay(self) -> None:
        ...
        self._blit_centered(self.font_small.render("ANGREIFER GEWAEHLT", True, (180, 100, 100)), card_y + 22)
        self._blit_centered(self.font_large.render(attacker.name.replace("_", " ").title(), True, player.color), card_y + 55)
        self._blit_centered(self.font.render(f"{attacker.troops} Truppen verfuegbar", True, (255, 230, 80)), card_y + 115)
        pygame.draw.line(self.screen, (80, 40, 40), (card_x + 30, card_y + 148), (card_x + 550, card_y + 148), 1)
        self._blit_centered(self.font.render("Waehle das Territorium, das du angreifen moechtest", True, (230, 220, 220)), card_y + 165)

        self.attack_defender_intro_continue_rect = self._draw_button("Weiter", card_x, card_y + 242, 580, (170, 35, 35), (220, 70, 70))
    ...
    def _draw_combat_roll_overlay(self) -> None:
        ...
        self._blit_centered(self.font_large.render("KAMPF!", True, (220, 60, 60)), card_y + 18)
        pygame.draw.line(self.screen, (80, 30, 30), (card_x + 30, card_y + 78), (card_x + 690, card_y + 78), 1)

        # Angreifer
        self.screen.blit(self.font.render(attacker.name.replace("_", " ").title(), True, player.color), (card_x + 40, card_y + 90))
        self.screen.blit(self.font_large.render(str(attacker.troops), True, (255, 230, 80)), (card_x + 40, card_y + 122))
        ...
        pygame.draw.line(self.screen, (80, 30, 30), (card_x + 30, card_y + 205), (card_x + 690, card_y + 205), 1)
        self._blit_centered(self.font_small.render("Wuerfelanzahl waehlen:", True, (200, 180, 180)), card_y + 218)
        ...
        for i in range(1, 4):
            ...
            if not available:
                ...
                bg = (100, 50, 50) if r.collidepoint(mx, my) else (70, 35, 35)
                fg = (255, 255, 255)

            pygame.draw.rect(self.screen, bg, r, border_radius=8)
            if available:
                border_col = (180, 40, 40) if selected else (120, 60, 60)
                pygame.draw.rect(self.screen, border_col, r, 2, border_radius=8)
    ...
    def _draw_combat_result_overlay(self) -> None:
        ...
        self._blit_centered(self.font_large.render("WUERFELERGEBNIS", True, (220, 60, 60)), card_y + 18)
        pygame.draw.line(self.screen, (80, 30, 30), (card_x + 30, card_y + 78), (card_x + 710, card_y + 78), 1)

        # Angreifer-Seite
        self.screen.blit(self.font.render(attacker.name.replace("_", " ").title(), True, player.color), (card_x + 40, card_y + 90))
        for i, d in enumerate(combat.attacker_dice):
            self._draw_die(card_x + 40 + i * 82, card_y + 125, d, (180, 40, 40))
        loss_a = self.font.render(f"Verluste: -{combat.last_attacker_losses}", True,
                                  (255, 90, 90) if combat.last_attacker_losses > 0 else (100, 180, 100))
        self.screen.blit(loss_a, (card_x + 40, card_y + 210))
        self.screen.blit(self.font_small.render(f"Verbleibend: {attacker.troops} Truppen", True, (200, 200, 200)),
                         (card_x + 40, card_y + 245))

        pygame.draw.line(self.screen, (80, 30, 30), (WIDTH // 2, card_y + 88), (WIDTH // 2, card_y + 275), 1)
        ...
        loss_d = self.font.render(f"Verluste: -{combat.last_defender_losses}", True,
        ...
        self.screen.blit(self.font_small.render(f"Verbleibend: {defender.troops} Truppen", True, (200, 200, 200)),
                         (card_x + 740 - 40 - self.font_small.size(f"Verbleibend: {defender.troops} Truppen")[0], card_y + 245))

        pygame.draw.line(self.screen, (80, 30, 30), (card_x + 30, card_y + 285), (card_x + 710, card_y + 285), 1)
        ...
        if self.combat_last_conquered or not self.combat_last_can_continue:
            ...
            self.combat_result_continue_rect = self._draw_button("Weiter", card_x, card_y + 430, 740, c, c_h)
            self.combat_result_end_rect = None
        else:
            btn_w = 240
            gap   = 20
            ...
            bx2   = bx1 + btn_w + gap
            by    = card_y + card_y + 500 - btn_h - 22  # aligned to bottom
            ...
            pygame.draw.rect(self.screen, (220, 70, 70) if self.combat_result_continue_rect.collidepoint(mx, my) else (170, 35, 35),
            ...
            pygame.draw.rect(self.screen, (75, 85, 100) if self.combat_result_end_rect.collidepoint(mx, my) else (55, 65, 80),
    ...
    def _draw_menu(self) -> None:
        ...
        for text, rect in [("Weiter", self.resume_rect), ("Beenden", self.quit_rect)]:
    ...
    def _draw_overlay_card(self, fill: tuple, border: tuple, card_w: int, card_h: int) -> None:
        """Zeichnet den halbtransparenten Hintergrund + Karte zentriert."""
        overlay = pygame.Surface((WIDTH, HEIGHT), pygame.SRCALPHA)
    ...
    def _draw_button(self, label: str, card_x: int, card_y_offset: int, card_w: int,
                     color_normal: tuple, color_hover: tuple, font=None) -> pygame.Rect:
        """Zeichnet einen zentrierten Button und gibt sein Rect zurück."""
        ...
        pygame.draw.rect(self.screen, color_hover if hover else color_normal, rect, border_radius=10)
